...
use App\Filament\Resources\ContractGeneratorResource\Pages\CreateContractGenerator;
use App\Filament\Resources\ContractGeneratorResource\Pages\EditContractGenerator;
use App\Filament\Resources\ContractGeneratorResource\Pages\ListContractGenerators;
use App\Filament\Resources\ContractGeneratorResource\Pages\ViewContractGenerator;
...
class ContractGeneratorResource extends Resource implements HasShieldPermissions
{
    ...
    {
        $count = Generator::where('type', 2)->count();
        return $count;
    }
    ...
    {
        return $table
            ->query(static::$model::query()->where('type', 2))
                ...
                TextColumn::make('contractGenerator.contract.customer.name')
                    ...
                    ->searchable(true, function ($query, $search) {
                        return $query->where(function ($query) use ($search) {
                            $query->whereHas('contractGenerator.contract.customer', function ($query) use ($search) {
    ...
    {
        return [
            'index' => ListContractGenerators::route('/'),
