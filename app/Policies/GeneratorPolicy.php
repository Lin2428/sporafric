...
class GeneratorPolicy
{
    ...
    {
        return $user->can('view_any_generator');
    }
    ...
    {
        return $user->can('view_generator');
    }
    ...
    {
        return $user->can('create_generator');
    }
    ...
    {
        return $user->can('update_generator');
    }
    ...
    {
        return $user->can('delete_generator');
    }
    ...
    {
        return $user->can('delete_any_generator');
    }
