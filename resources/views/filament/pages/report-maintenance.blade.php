    ...
    <div id="printable" style="font-family: Helvetica, Arial, sans-serif;">
        ...
        <x-daily-report-header title="Rapport de maintenance" :contracts="$contracts" />
         ...
         <div class="flex justify-between border border-slate-400 p-3 mt-1 rounded-md bg-white">
            <div>
                @include('filament.forms.components.select-contract-result', ['contract' => $this->contract])
            </div>
            ...
            <thead>
                <tr>
                    ...
                    <th class="px-3 py-2 text-[12px] font-bold text-center text-slate-800 border border-slate-400">
                     ...
                     <th class="px-3 py-2 text-[12px] font-bold text-center text-slate-800 border border-slate-400">
                        Nombre GE</th>
                    <th class="px-3 py-2 text-[12px] font-bold text-center text-slate-800 border border-slate-400">Forfait
                    </th>
                    <th class="px-3 py-2 text-[12px] font-bold text-center text-slate-800 border border-slate-400">Payé</th>
