...
<x-filament-panels::page>
    ...
    @if($type === '0')
            ...
            <thead>
                <tr>
                    ...
                    <th class="px-3 py-4 text-sm font-bold text-center text-slate-800 border border-slate-400">
                        Interventions</th>
                    <th class="px-3 py-4 text-sm font-bold text-center text-slate-800 border border-slate-400">Cout du devis
                    </th>
        ...
        <table class="min-w-full border border-slate-400 divide-y divide-slate-300">
            ...
            <tbody>
                <tr>
                    <td class="px-3 text-sm py-2 font-semibold text-right text-slate-800 border border-slate-400">
